...
const listarCargos = async () => {
    ...
    try {
        ...
        const result = cargoDAO.getSelectAllResponsability()
...
const buscarCargoId = async (id) => {
    ...
    try {
        ...
        if (!isNaN(id) && id != "" && id != null && id != undefined && id > 0) {
            ...
            const result = cargoDAO.getSelectResponsabilityById(id)
...
const excluirCargo = (id) => {
    ...
    try {
        ...
        let validarId = buscarCargoId(id)

        if (validarId.status_code == 200) {

            const result = cargoDAO.setDeleteResponsabilityById(id)
            ...
            if(result) {
                ...
                delete MESSAGES.DEFAULT_MESSAGES.items
